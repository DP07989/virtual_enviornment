...
with open("homeZZ_data_targoviste.csv", "a+", newline="", encoding="utf-8") as homeZZ_csv:
    ...
    # Write header
        writer.writerow([
            ...
            "Stare", "Numar camere", "Numar bai", "Mobilat", "Tip tranzactie","An" ,  "Pret"
        ])
    ...
    for i in range(1, pages_to_scrape + 1):
        ...
        page_adress = f"https://homezz.ro/vanzare-case-vile/targoviste-db?page={i}"
            ...
            if specs_section:
                ...
                for spec in specs:
                    ...
                    if len(spans) == 2:
                        ...
                        elif "An finalizare construcție" in name:
                            property_instance.an = value
